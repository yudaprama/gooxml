...
func Example_document() {
	// see the github.com/yudaprama/gooxml/document documentation or _examples/document
	// for more examples
	doc := document.New()
...
func Example_spreadsheeet() {
	// see the github.com/yudaprama/gooxml/spreadsheet documentation or _examples/spreadsheet
	// for more examples
	ss := spreadsheet.New()
	sheet := ss.AddSheet()
